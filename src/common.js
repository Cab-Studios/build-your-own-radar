...
require('./images/cab-logo.svg')
require('./images/cab-logo-black.svg')
require('./images/cab-share.png')
require('./images/cab-engine-logo-white.svg')
require('./images/search-active-wave_white.svg')
require('./images/thoughtworks-logo.svg')
